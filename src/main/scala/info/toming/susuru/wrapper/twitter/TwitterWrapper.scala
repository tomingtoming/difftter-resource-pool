...
class TwitterWrapper(val t: Twitter) extends Twitter
with OAuthSupportWrapper[Twitter]
with OAuth2SupportWrapper[Twitter]
with TwitterBaseWrapper[Twitter]
with TimelinesResourcesWrapper[Twitter]
with TweetsResourcesWrapper[Twitter]
with SearchResourceWrapper[Twitter]
with DirectMessagesResourcesWrapper[Twitter]
with FriendsFollowersResourcesWrapper[Twitter]
with UsersResourcesWrapper[Twitter]
with SuggestedUsersResourcesWrapper[Twitter]
with FavoritesResourcesWrapper[Twitter]
with ListsResourcesWrapper[Twitter]
with SavedSearchesResourcesWrapper[Twitter]
with PlacesGeoResourcesWrapper[Twitter]
with TrendsResourcesWrapper[Twitter]
with SpamReportingResourceWrapper[Twitter]
with HelpResourcesWrapper[Twitter] {
...
trait TimelinesResourcesWrapper[T <: TimelinesResources] extends TimelinesResources with Wrapper[T] {
...
trait TweetsResourcesWrapper[T <: TweetsResources] extends TweetsResources with Wrapper[T] {
...
trait SearchResourceWrapper[T <: SearchResource] extends SearchResource with Wrapper[T] {
  override def search(query: Query): QueryResult = t.search(query)
}

trait DirectMessagesResourcesWrapper[T <: DirectMessagesResources] extends DirectMessagesResources with Wrapper[T] {
...
trait FriendsFollowersResourcesWrapper[T <: FriendsFollowersResources] extends FriendsFollowersResources with Wrapper[T] {
...
trait UsersResourcesWrapper[T <: UsersResources] extends UsersResources with Wrapper[T] {
...
trait SuggestedUsersResourcesWrapper[T <: SuggestedUsersResources] extends SuggestedUsersResources with Wrapper[T] {
...
trait FavoritesResourcesWrapper[T <: FavoritesResources] extends FavoritesResources with Wrapper[T] {
...
trait ListsResourcesWrapper[T <: ListsResources] extends ListsResources with Wrapper[T] {
...
trait SavedSearchesResourcesWrapper[T <: SavedSearchesResources] extends SavedSearchesResources with Wrapper[T] {
...
trait PlacesGeoResourcesWrapper[T <: PlacesGeoResources] extends PlacesGeoResources with Wrapper[T] {
...
trait TrendsResourcesWrapper[T <: TrendsResources] extends TrendsResources with Wrapper[T] {
...
trait SpamReportingResourceWrapper[T <: SpamReportingResource] extends SpamReportingResource with Wrapper[T] {
  override def reportSpam(l: Long): User = t.reportSpam(l)

  override def reportSpam(s: String): User = t.reportSpam(s)
}

trait HelpResourcesWrapper[T <: HelpResources] extends HelpResources with Wrapper[T] {
